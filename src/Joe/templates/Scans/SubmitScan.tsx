...
import { AppSelectOrCreate } from "./AppSelectOrCreate";
import {
  cancelScanRequest,
  getAppsByUrl,
  getScanStatus,
...
export const SubmitScan: React.FC<SubmitScanProps> = () => {
  const { refetchScans } = useContext(ScansPageContext);
                ...
                <Box style={{ flex: 1 }}>
                  <Group justify="space-between">
                    ...
                    <Flex className="items-center">
                      <ScanSettings selectedAppId={selectedApp?.appId} />
                          ...
                          <Menu.Target>
                            <ActionIcon
                              ...
                              style={{
                                ...
                                border: 0,
                                borderLeft:
                                  "1px solid var(--mantine-color-body)",
                              }}
                            >
              ...
              <div className={"flex w-3/4 items-center gap-x-4 pb-4"}>
                <Group w="100%" mt="sm" justify="space-betwen" px="md">
                  ...
                  <Text variant="h3" className="text-black">{`${
                    !isNaN(statusValue) ? (statusValue * 100).toFixed(0) : 0
                  }%`}</Text>
                </Group>
              </div>
            )}
